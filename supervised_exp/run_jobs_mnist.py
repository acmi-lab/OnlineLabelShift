    ...
    for algorithm in ALGORITHMS: 
        for label_shift_type in LABEL_SHIFT_TYPE: 
            ...
            for calibrate in CALIBRATE: 
                ...
                --seed 42 --pretrained False --transform image_none --algorithm  {algorithm}\
                --target_resolution 28 --resize_resolution 28 --default_normalization False --mean 0.1307  --std  0.3081 \
                ...
                --model MLP --lr 0.1 --optimizer SGD --weight_decay 0.0001 --optimizer_kwargs momentum=0.9 --batch_size 200 --progress_bar"
