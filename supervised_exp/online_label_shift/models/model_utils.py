...
def linear_probe_SGD(model, dataloader, epochs, wd, device, progress_bar=True): 
    ...
    optimizer = torch.optim.SGD(model[1].parameters(), lr=0.01, momentum=0.9, weight_decay=wd)
    ...
    for epoch in range(epochs):        
        logger.info(f"Linear probing iteration {epoch+1} ... ")
