...
def get_parser():
    ...
    parser.add_argument("--rogd-lrs", default="0.01 0.05 0.1 0.2 0.4 0.8 1.6", type=str, required=False)
    return parser

def submit_vary_rogd_lr(
    data_name,
    model_name,
    rogd_lrs,
    cuda_device_id,
    ...
    for seed in seeds:
        command = (
            ...
            f" --rogd-lrs '{rogd_lrs}' --do-rogd 1 --save 1"
        )
